...
"""
AI Workflow PUCT Tracker — v0.1

A Tkinter GUI with a Pandas/NetworkX backend for managing an AI-directed
tree search. Implements a rank-based PUCT scoring scheme
to pick the next node to explore and visualize the search tree.

AI Assistance Disclosure:
  Portions of this code were drafted/edited with Google Gemini assistance.
  All logic and outputs were reviewed and tested by the author.

Usage:
  Run directly: `python puct_tracker_gui.py` (TkAgg backend required)

Author: Jerry Gao
License: MIT (see LICENSE in the repository)
"""
__author__  = "Jerry Gao"
__version__ = "0.1.0"
__license__ = "MIT"
...
class PUCTTrackerApp(tk.Tk):
    ...
    def add_node_event(self):
        try:
            ...
            self.manager.add_node(parent_id, ari_score, notes, code)
            self.refresh_ui()
